...
export default function Home() {
  ...
  useEffect(() => {
    ...
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
      <Container>
        <div ref={refScrollContainer} className="relative z-10 min-h-screen" style={isMobile ? {
          ...mobileCSSOptimizations.optimizedScroll,
          paddingTop: '0',
          margin: '0',
          minHeight: '100vh',
          height: '100vh'
        ...
        {/* HERO SECTION - Optimized for mobile full screen utilization */}
        <section
          id="home"
          data-scroll-section
          className="relative min-h-screen pt-0 mt-0 mx-auto flex w-full max-w-full sm:max-w-7xl flex-col items-center justify-center xl:mt-0 xl:min-h-screen xl:flex-row xl:justify-between px-4 sm:px-6 lg:px-8"
        >
          <div className={styles.intro}>
            ...
            <div className="mb-6">
              ...
              <p
                ...
                data-scroll-enable-touch-speed
                data-scroll-speed=".06"
                className="mt-4 max-w-lg tracking-tight text-muted-foreground 2xl:text-xl leading-relaxed"
              >
            ...
            <span
              ...
              data-scroll-enable-touch-speed
              data-scroll-speed=".06"
              className="flex flex-row items-center space-x-1.5 pt-8"
            >

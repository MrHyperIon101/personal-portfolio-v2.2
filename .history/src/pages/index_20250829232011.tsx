...
const experiences = [
  {
    ...
    technologies: ["Project Management", "Testing", "Software Testing", "Functional Testing", "Samsung Ecosystem", "Mobile Testing", "Wearable Testing", "Smart TV Testing", "Quality Assurance", "Bug Reporting", "User Experience Testing", "Platform Development"],
  },
  {
    ...
    technologies: ["Google Cloud Platform (GCP)", "Cloud Applications", "Cloud Computing", "Machine Learning", "Big Data", "Security", "Google Cloud Skills Boost", "Cloud Architecture", "AI/ML", "Data Analytics", "Cloud Security", "DevOps", "Kubernetes", "Docker"],
  },
  {
    ...
    technologies: ["CUDA", "Artificial Intelligence (AI)", "Accelerated Computing", "Deep Learning", "GPU Programming", "Neural Networks", "Computer Vision", "TensorFlow", "PyTorch", "NVIDIA SDK", "High Performance Computing", "Training & Facilitation"],
  },
  {
    company: "CodeAlpha",
    ...
    technologies: ["Visual Web Developer", "Software Infrastructure", "Engineering", "Internet Software", "UI/UX Design", "Responsive Design", "HTML5", "CSS3", "JavaScript", "React", "Frontend Development", "Design Systems", "Collaboration"],
  },
  {
    ...
    technologies: ["Python (Programming Language)", "Software Infrastructure", "Engineering", "Agile Methodologies", "Code Optimization", "Software Development", "Django", "Flask", "API Development", "Database Management", "Git", "Team Collaboration"],
  },
  {
    company: "Microsoft",
    ...
    technologies: ["Windows", "Windows Server", "Windows Canary", "Beta Testing", "GitHub", "Windows 11", "Bug Reporting", "System Testing", "OS Development", "User Feedback", "Quality Assurance", "Developer Collaboration"],
  },
  {
    ...
    technologies: ["Software Development", "Web Development", "SDLC", "GitHub", "GitHub Actions", "GitHub API", "Open Source", "Git", "CI/CD", "DevOps", "REST APIs", "Developer Tools"],
  },
  {
    ...
    technologies: ["Community Building", "Google Cloud", "Android Development", "Web Development", "Event Management", "Knowledge Sharing", "Networking", "Technology Advocacy", "Public Speaking", "Workshop Facilitation"],
  },
  {
    ...
    technologies: ["Community Engagement", "Technology Advocacy", "Innovation", "Collaboration", "Hackathons", "Tech Talks", "Regional Development", "Mentoring", "Event Participation", "Tech Ecosystem"],
  },
  {
    ...
    technologies: ["Beta Testing", "Product Feedback", "Community Management", "Nothing OS", "Mobile OS Testing", "User Experience", "Product Development", "Global Community", "Feature Testing", "Consumer Electronics"],
  },
  {
    ...
    technologies: ["HTML5", "CSS3", "JavaScript", "React", "Node.js", "MongoDB", "Full-Stack Development", "Express.js", "RESTful APIs", "Database Design", "Version Control", "Responsive Design", "Modern Web Frameworks"],
  },
];
...
const projects = [
  {
    ...
    technologies: ["Artificial Intelligence (AI)", "React", "Node.js", "TypeScript", "MongoDB", "Machine Learning", "Natural Language Processing", "Task Automation", "RESTful APIs", "Express.js", "JWT Authentication", "Real-time Updates"],
  },
  {
    ...
    technologies: ["React", "TypeScript", "JavaScript", "CSS3", "Web Development", "Performance Analytics", "Real-time Statistics", "Responsive Design", "Local Storage", "Progressive Web App", "Vercel Deployment"],
  },
  {
    title: "TechBuild AI",
    ...
    technologies: ["Artificial Intelligence (AI)", "React", "Python (Programming Language)", "Machine Learning", "Computer Hardware Analysis", "Recommendation Systems", "Data Processing", "Component Compatibility", "Performance Optimization", "Cost Analysis"],
  },
  {
    title: "PurixOS",
    ...
    technologies: ["Operating Systems", "C++", "Assembly", "System Programming", "Kernel Development", "Low-level Programming", "Memory Management", "Process Scheduling", "Device Drivers", "System Architecture", "Boot Loaders", "File Systems"],
  },
  {
    title: "FinanceFlow",
    ...
    technologies: ["Artificial Intelligence (AI)", "React", "Node.js", "MongoDB", "Financial Technology", "Data Visualization", "Expense Tracking", "Budget Analysis", "Predictive Analytics", "Secure Transactions", "Dashboard Design", "Firebase"],
  },
  {
    title: "EVENTIQ",
    ...
    href: "#",
    technologies: ["React", "Event Management", "Database Management", "UI/UX Design", "Calendar Integration", "Registration System", "Payment Processing", "Real-time Notifications", "Admin Dashboard", "User Management", "Event Analytics", "Mobile Responsive"],
  },
];
...
export default function Home() {
  ...
  const openExperienceDetail = (experience: typeof experiences[0]) => {
    ...
    console.log('Setting selectedExperience and isExperiencePopupOpen to true');
    ...
    setTimeout(() => {
      setSelectedExperience(experience);
      setIsExperiencePopupOpen(true);
      console.log('Secondary state update completed');
    }, 0);
  ...
  return (
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
      ...
      {/* Debug State Display - Can be removed now */}
      <div className="fixed top-4 right-4 bg-green-600 text-white p-4 rounded-lg text-xs z-[10000] border-2 border-green-400">
        <div>✅ All technologies now visible in cards!</div>
        <div>✅ No more popups needed</div>
        <div>✅ Better user experience</div>
        <button 
          onClick={() => {
            const debugPanel = document.querySelector('[class*="fixed top-4 right-4"]');
            if (debugPanel) debugPanel.remove();
          }}
          className="mt-2 px-2 py-1 bg-green-800 text-white rounded text-xs"
        >
          Remove This Panel
        </button>
      </div>
      ...
      {/* Original Complex Popup - Temporarily Disabled */}
      <div style={{ display: 'none' }}>
      <AnimatePresence>
        {(() => {
          console.log('Popup render check:', {
            isExperiencePopupOpen,
            selectedExperience: selectedExperience?.company || 'null'
          });
          return isExperiencePopupOpen && selectedExperience;
        })() && selectedExperience && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      {/* Popup removed - all technologies now visible in cards */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}

                              ...
                              >
                                ...
                                {project.technologies?.length > 3 && (
                                  <motion.span
                                    ...
                                    viewport={{ once: true }}
                                    className="px-3 py-1 text-xs font-medium text-secondary/90 bg-secondary/10 border border-secondary/20 rounded-full backdrop-blur-sm hover:bg-secondary/20 transition-all duration-300 cursor-pointer z-10 pointer-events-auto"
                            ...
                            >
                              ...
                              {cert.technologies.length > 2 && (
                                <motion.button 
                                  ...
                                  viewport={{ once: true }}
                                  className="inline-block text-xs text-muted-foreground whitespace-nowrap hover:text-primary transition-colors duration-300 cursor-pointer bg-muted/10 hover:bg-primary/10 px-2 py-1 rounded-full border border-muted/20 hover:border-primary/30 z-10 pointer-events-auto"
        ...
        <button 
          onClick={() => {
            ...
            if (experiences.length > 0) {
              openExperienceDetail(experiences[0]);
            }
          }}
        ...
        <button 
          onClick={() => {
            ...
            if (projects.length > 0) {
              openProjectTechPopup(projects[0]);
            }
          }}

...
export default function Home() {
  ...
  const ultraSmoothVariants = getUltraSmoothVariants();
  const ultraSmoothGestures = getUltraSmoothGestureSettings();
  ...
  // Ultra-smooth loading state management
  const [isLoading, setIsLoading] = useState(true);
  
  useEffect(() => {
    const handleUltraSmoothPageLoad = () => {
    ...
    // Ultra-smooth page load timing
    const loadTimer = setTimeout(handleUltraSmoothPageLoad, 1500);
                          ...
                          >
                            ...
                            {exp.technologies.length > 3 && (
                              <motion.span
                                ...
                                viewport={{ once: true }}
                                className="inline-block rounded-full bg-gradient-to-r from-muted/20 to-muted/10 px-3 py-1 text-xs font-medium text-muted-foreground whitespace-nowrap"
                              >

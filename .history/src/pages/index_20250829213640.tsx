                              ...
                              >
                                ...
                                {project.technologies?.length > 3 && (
                                  <motion.span
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    onClick={() => openProjectTechPopup(project)}
                                    transition={{ 
                                    ...
                                    viewport={{ once: true }}
                                    className="px-3 py-1 text-xs font-medium text-secondary/90 bg-secondary/10 border border-secondary/20 rounded-full backdrop-blur-sm hover:bg-secondary/20 transition-all duration-300 cursor-pointer"
            ...
            >
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2 text-blue-400 mb-2">
                  ...
                  <span className="font-semibold">All Technologies Used</span>
                </div>
              ...
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-4">Complete Technology Stack</h4>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {selectedProject.technologies.map((tech, index) => (
                    <motion.div
                      ...
                      className="group relative p-3 bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-400/20 rounded-lg backdrop-blur-sm hover:border-blue-400/40 transition-all duration-300 cursor-pointer"
                    >
                      ...
                      {/* Inner content */}
                      <div className="relative bg-gray-900/80 rounded-md p-2 backdrop-blur-sm">
                        <span className="text-blue-300 font-medium text-sm">{tech}</span>
                      </div>
                      
                      {/* Shimmer effect */}
                      <div className="absolute inset-0 rounded-lg overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -skew-x-12 group-hover:animate-[shimmer_2s_ease-in-out_infinite]" />
                      </div>
                    </motion.div>
                  ))}
                </div>
              ...
              <div className="pt-4 border-t border-gray-700/50">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 hover:from-blue-500 hover:via-purple-500 hover:to-blue-500 text-white rounded-xl font-bold text-lg transition-all duration-500 shadow-2xl hover:shadow-blue-500/50 overflow-hidden"
                  style={{
                ...
                >
                  ...
                  {/* Inner background */}
                  <div className="absolute inset-[2px] rounded-[10px] bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600" />
                  
                  {/* Shimmer effect */}
                  <div className="absolute inset-[2px] rounded-[10px] overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -skew-x-12 group-hover:animate-[shimmer_1.5s_ease-in-out_infinite]" />
                  </div>

    ...
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
      <Container>
        ...
        <section
          id="home"
          data-scroll-section
          className="relative min-h-screen pt-0 mt-0 mx-auto flex w-full max-w-7xl flex-col items-center xl:mt-0 xl:min-h-screen xl:flex-row xl:justify-between px-4 sm:px-6 lg:px-8"
        >

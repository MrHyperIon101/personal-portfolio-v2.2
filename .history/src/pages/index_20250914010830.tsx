    ...
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
      <Container>
        ...
        <section
          id="home"
          data-scroll-section
          className="relative mt-0 pt-24 sm:pt-20 xl:pt-0 xl:mt-0 mx-auto flex w-full max-w-7xl flex-col items-center xl:min-h-screen xl:flex-row xl:justify-between px-4 sm:px-6 lg:px-8"
        >

                            ...
                            >
                              ...
                              {cert.technologies.length > 2 && (
                                <motion.button 
                                  ...
                                  viewport={{ once: true }}
                                  className="inline-block text-xs text-muted-foreground whitespace-nowrap hover:text-primary transition-colors duration-300 cursor-pointer bg-muted/10 hover:bg-primary/10 px-2 py-1 rounded-full border border-muted/20 hover:border-primary/30"

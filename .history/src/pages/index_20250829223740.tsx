...
export default function Home() {
  ...
  return (
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
                              ...
                              >
                                ...
                                {project.technologies?.length > 3 && (
                                  <div
                                    ...
                                    className="px-3 py-1 text-xs font-medium text-secondary/90 bg-secondary/10 border border-secondary/20 rounded-full backdrop-blur-sm hover:bg-secondary/20 transition-all duration-300 cursor-pointer z-[50] pointer-events-auto hover:scale-110"
                            ...
                            >
                              ...
                              {cert.technologies.length > 2 && (
                                <div
                                  ...
                                  className="inline-block text-xs text-muted-foreground whitespace-nowrap hover:text-primary transition-colors duration-300 cursor-pointer bg-muted/10 hover:bg-primary/10 px-2 py-1 rounded-full border border-muted/20 hover:border-primary/30 z-[50] pointer-events-auto hover:scale-105"
      ...
      {/* Debug State Display */}
      <div className="fixed top-4 right-4 bg-red-900 text-white p-4 rounded-lg text-xs z-[10000] border-2 border-yellow-400">
        ...
        {/* Always visible test popup */}
        {isExperiencePopupOpen && (
          <div className="fixed inset-0 bg-green-500/50 z-[9999] flex items-center justify-center">
            <div className="bg-white text-black p-8 rounded-lg">
              <h2>TEST POPUP IS WORKING!</h2>
              <p>Experience: {selectedExperience?.company}</p>
              <button onClick={closePopups} className="mt-4 px-4 py-2 bg-red-500 text-white rounded">
                Close Test
              </button>
            </div>
          </div>
      ...
      {isExperiencePopupOpen && selectedExperience && (
        <div
          className="fixed inset-0 bg-red-500/80 z-[99999] flex items-center justify-center"
          onClick={closePopups}
        >
          <div 
          ...
          >
            <h2 className="text-xl font-bold mb-4">SIMPLE POPUP TEST</h2>

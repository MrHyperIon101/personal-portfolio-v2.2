...
export default function Home() {
  ...
  useEffect(() => {
    ...
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
      <Container>
        <div ref={refScrollContainer} style={isMobile ? mobileCSSOptimizations.optimizedScroll : undefined}>
        {/* Animated Background */}
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  <Card className="group relative overflow-hidden bg-transparent border-2 border-white/10 backdrop-blur-sm transition-all duration-500 hover:border-primary/30 h-full hover:shadow-2xl hover:shadow-primary/20">
                    ...
                    <div className="absolute inset-[2px] rounded-[10px] bg-gradient-to-br from-primary/10 via-transparent to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                {projects.map((project, index) => {
                  ...
                  <motion.div
                    ...
                    whileHover={isMobile ? {} : { 
                      y: -15, 
                      scale: 1.02,
                      rotateY: isTablet ? 0 : 5,
                      transition: { duration: 0.2 }
                    }}
                    whileTap={gestureSettings.whileTap}
                    transition={{ 
                      duration: isMobile ? (mobileConfig?.animationDuration ?? 0.4) : 0.4, 
                      delay: index * (isMobile ? 0.02 : 0.05) + (isMobile ? 0.1 : 0.2),
                      ease: "easeOut"
                    }}
                    viewport={{ once: true }}
                  ...
                  >
                        <Card 
                          ...
                          className={`group h-full overflow-hidden bg-transparent border-2 border-white/10 transition-all duration-${isMobile ? '200' : '300'} hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/20 ${
                            isMobile && mobileConfig?.reduceBlur ? 'backdrop-blur-sm' : 'backdrop-blur-sm'
                          }`}
                        >
                          {/* Rotating border gradient for project cards */}
                          <div className="absolute inset-0 rounded-xl overflow-hidden">
                            <div 
                              className="absolute inset-[-2px] rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                              style={{
                          ...
                          {/* Hover gradient overlay */}
                          <div className="absolute inset-[2px] rounded-[10px] bg-gradient-to-br from-primary/10 via-transparent to-secondary/10 opacity-0 group-hover:opacity-60 transition-opacity duration-500" />
                            ...
                            <Link href={project.href} target="_blank" passHref>
                              ...
                              >
                                <Image
                                  ...
                                  height={300}
                                  quality={100}
                                  className="aspect-video h-full w-full rounded-t-md bg-primary object-cover transition-transform duration-300 group-hover:scale-110"
                                />
                                <motion.div 
                                  initial={{ opacity: 0 }}
                                  whileHover={{ opacity: 1 }}
                                ...
                                >
                                  <div className="rounded-full bg-gradient-to-r from-primary/30 to-secondary/30 p-3 backdrop-blur-md border border-white/20">
                                ...
                                >
                                  <motion.div
                                    whileHover={{ scale: 1.05 }}
                                    className="bg-gradient-to-r from-primary/20 to-secondary/20 backdrop-blur-md rounded-lg px-3 py-1 border border-white/10"
                                  >
                          ...
                          <CardContent className="p-6 relative z-20">
                            <motion.div
                              ...
                              viewport={{ once: true }}
                            >
                              <CardTitle className="text-lg font-semibold tracking-tight text-foreground mb-3 line-clamp-2 group-hover:text-primary transition-colors duration-300">
                                {project.title}
                              </CardTitle>
                              <p className="text-sm text-muted-foreground leading-relaxed break-words line-clamp-3 group-hover:text-foreground transition-colors duration-300">
                                {project.description}
                              </p>
                            </motion.div>
                          </CardContent>
                          <motion.div
                            className="absolute inset-0 rounded-lg bg-gradient-to-br from-primary/10 via-transparent to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                            initial={false}
                          />
                        </Card>
                  </motion.div>
                            ...
                            >
                              ...
                              {cert.technologies.length > 2 && (
                                <motion.span 
                                  ...
                                  viewport={{ once: true }}
                                  className="inline-block text-xs text-muted-foreground whitespace-nowrap hover:text-primary transition-colors duration-300"
                                >
                                  +{cert.technologies.length - 2}
                                </motion.span>
                              )}
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={closePopups}
                className="absolute top-4 right-4 p-2 text-gray-400 hover:text-white transition-colors duration-200 bg-gray-800/50 rounded-full backdrop-blur-sm"
              >
                <X className="h-5 w-5" />
              </motion.button>
        ...
        {isCertificationPopupOpen && selectedCertification && (
          ...
          >
            ...
            >
              ...
              {/* Header */}
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-white mb-2">{selectedCertification.name}</h3>
                <div className="flex items-center gap-2 text-emerald-400 mb-2">
              ...
              {selectedCertification.credentialUrl && (
                <div>
                  <motion.a
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-medium transition-colors duration-200"
                  >
                    <ExternalLink className="h-4 w-4" />
                    View Credential
                  </motion.a>

  ...
  useEffect(() => {
    ...
    <MobilePerformanceMonitor enableMonitoring={process.env.NODE_ENV === 'development'}>
      <Container>
        ...
        >
          <div className={styles.intro}>
            ...
            <div>
              ...
              >
                <span className="text-gradient font-semibold">Google Campus Ambassador</span> and{" "}
                <span className="text-gradient font-semibold">Google Cloud Innovator</span> pursuing B.Tech CSE 
                (Data Science) at <span className="text-primary font-medium">Sikkim Manipal Institute of Technology</span>. 
                Leading <span className="text-primary font-medium">500+ learners</span> as{" "}
                <span className="text-gradient font-semibold">Google Cloud Arcade Facilitator</span>, while contributing to{" "}
                <span className="text-primary font-medium">Kotlin Kolkata UG</span> and working at{" "}
                <span className="text-gradient font-semibold">Samsung Electronics</span> as{" "}
                <span className="text-primary font-medium">Remote Lab Tester</span>.
              </p>
            </div>
            <span
              data-scroll
          ...
          {/* Hide entire vector art container on mobile */}
          {!isMobile && (
            <div
              data-scroll
        ...
        {/* Experience */}
        <section id="experience" data-scroll-section className="relative z-10">
          <div
            data-scroll
            data-scroll-speed=".4"
            data-scroll-position="top"
            className="my-10 mx-auto flex w-full max-w-7xl flex-col justify-start space-y-8 px-4 sm:px-6 lg:px-8 pb-16"
          >
            <motion.div 
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.div 
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
              className="grid gap-6 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 w-full relative z-20"
            ...
            >
              {experiences.map((exp, index) => (
                ...
                >
                  <Card className="group relative overflow-hidden bg-transparent border-2 border-white/10 backdrop-blur-sm transition-all duration-500 hover:border-primary/30 h-full hover:shadow-2xl hover:shadow-primary/20 cursor-pointer">
          ...
          >
            ...
            >
              <motion.span
                ...
                transition={{ duration: 0.8, delay: 0.4 }}
                viewport={{ once: true }}
                className="inline-block align-baseline mr-2"
              >
                Let&apos;s work
              </motion.span>
              <motion.span 
                ...
                viewport={{ once: true }}
                className="text-gradient clash-grotesk inline-block cursor-pointer align-baseline"
              >
                together.
              </motion.span>
            </motion.h2>
        ...
        {isExperiencePopupOpen && selectedExperience && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-gray-900/95 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 shadow-2xl"
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedExperience.technologies.map((tech, index) => (
                    <motion.span
                      ...
                      className="px-3 py-1 bg-emerald-400/20 border border-emerald-400/30 rounded-full text-emerald-300 text-sm font-medium"
                    >
                      {tech}
                    </motion.span>
                  ))}
        ...
        {isCertificationPopupOpen && selectedCertification && (
          ...
          >
            ...
            >
              ...
              {/* Description */}
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-3">About the Certification</h4>
                <p className="text-gray-300 leading-relaxed">{selectedCertification.description}</p>
              </div>

              {/* Technologies */}
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-white mb-3">Technologies Covered</h4>
                <div className="flex flex-wrap gap-2">

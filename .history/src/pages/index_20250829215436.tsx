        ...
        {isCertificationPopupOpen && selectedCertification && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto pointer-events-auto mx-auto"
              style={{ margin: 'auto' }}
              onClick={(e) => e.stopPropagation()}
            >
      ...
      <AnimatePresence>
        {isProjectTechPopupOpen && selectedProject && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] min-h-screen flex p-4 bg-black/80 backdrop-blur-sm"

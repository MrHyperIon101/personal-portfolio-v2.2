...
const AnimatedBackground: React.FC<AnimatedBackgroundProps> = ({ activeSection = 'home' }) => {
  ...
  // Ultra-lightweight color schemes - pure performance
  const sectionThemes = {
    home: { primary: '#00d4ff', glow: '#0066ff08' },
    about: { primary: '#ff0080', glow: '#ff008008' },
    experience: { primary: '#7000ff', glow: '#7000ff08' },
    projects: { primary: '#00ff88', glow: '#00ff8808' },
    contact: { primary: '#ffaa00', glow: '#ffaa0008' }
  };

...
const AnimatedBackground: React.FC<AnimatedBackgroundProps> = ({ activeSection = 'home' }) => {
  ...
  // Darker, more sophisticated color schemes
  const sectionThemes = {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: -1 }}>
      ...
      {/* Mouse glow effect - darker */}
      <motion.div 
        className="absolute inset-0"
        style={{
          background: `radial-gradient(circle at ${mousePosition.x}px ${mousePosition.y}px, ${theme.glow} 0%, ${theme.secondary}20 30%, transparent 70%)`
        }}
        animate={{
          opacity: [0.3, 0.5, 0.3],
        }}
        ...
        {[...Array(3)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              background: `linear-gradient(45deg, ${theme.primary}20, ${theme.secondary}15, transparent)`,
      ...
      {[...Array(6)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            boxShadow: `0 0 ${20 + i * 10}px ${theme.primary}40, 0 0 ${30 + i * 15}px ${theme.secondary}30`,
          }}
          animate={{
            y: [-20, 20, -20],
            x: [-15, 15, -15],
      ...
      {/* Corner gradients - darker */}
      <motion.div
        className="absolute top-0 left-0 w-96 h-96"
        style={{
          background: `radial-gradient(circle at 0% 0%, ${theme.primary}30 0%, ${theme.secondary}20 30%, transparent 60%)`,
        }}
        animate={{
          opacity: [0.2, 0.4, 0.2],
          scale: [0.8, 1.3, 0.8]
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle at 100% 100%, ${theme.secondary}30 0%, ${theme.primary}20 30%, transparent 60%)`,
        }}
        animate={{
          opacity: [0.2, 0.4, 0.2],
          scale: [1.3, 0.8, 1.3]
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: `0 0 40px ${theme.primary}60, 0 0 60px ${theme.secondary}40`,
        }}
        animate={{
          scale: [1, 4, 1],
      ...
      <motion.div
        className="absolute inset-0"
        style={{
          backgroundImage: `radial-gradient(circle at 15px 15px, ${theme.primary}40 1px, transparent 1px)`,
